...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/notice/?type=6">WeChat列表</a></li>
		<shiro:hasPermission name="cms:notice:edit">
			<li><a href="${ctx}/cms/notice/form?type=6">WeChat新增</a>
			</li>
		</shiro:hasPermission> 
	</ul>
	<form:form id="searchForm" modelAttribute="notice" action="${ctx}/cms/notice/?type=6" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>标题</th><th>图片</th><th>内容</th><th>分享方式</th><th>应用范围</th><th> 链接</th><shiro:hasPermission name="cms:notice:edit"><th  style="width:10%">操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="notice">
			<tr>
				...
				<td>${notice.text}</td>
				<td>${fns:getDictLabel(notice.orderSum, 'wechat_share_type', '')}</td>
