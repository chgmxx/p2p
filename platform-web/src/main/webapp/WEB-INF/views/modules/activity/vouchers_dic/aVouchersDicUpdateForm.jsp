...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/activity/aVouchersDic/">抵用券字典数据列表</a></li>
		<li class="active"><a href="${ctx}/activity/aVouchersDic/updateForm?id=${aVouchersDic.id}">抵用券字典数据<shiro:hasPermission name="activity:aVouchersDic:edit">${not empty aVouchersDic.id?'修改':'添加'}</shiro:hasPermission> <shiro:lacksPermission name="activity:aVouchersDic:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="aVouchersDic" action="${ctx}/activity/aVouchersDic/updateSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
		<sys:message content="${message}" />
		<div class="control-group">
			<label class="control-label">编号，唯一标识：</label>
			<div class="controls">
				<form:input path="id" htmlEscape="false" class="input-xlarge" disabled="true"/>
			</div>
		</div>
		<div class="control-group">
