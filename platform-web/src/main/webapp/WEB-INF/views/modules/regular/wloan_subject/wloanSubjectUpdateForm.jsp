...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wloan_subject/wloanSubject/updateForm?id=${wloanSubject.id}">融资主体修改</a></li>
	</ul>
	<br />
	<!-- 融资主体类别. -->
	<form:form id="personalForm" modelAttribute="wloanSubject" action="${ctx}/wloan_subject/wloanSubject/updateSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="span6">
			...
			<div class="controls">
				<form:select path="type" class="input-large" id="wloan_subject_select" disabled="true">
		...
		<div class="control-group">
			...
			<div class="span6">
				<label class="control-label">开户银名称：</label>
				<div class="controls">
