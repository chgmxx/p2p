...
<!-- 	</ul> -->
	<form:form id="searchForm" action="${ctx}/sys/log/" modelAttribute="log" method="post" class="breadcrumb form-search">
		...
		<div>
			...
			<label>日期范围：&nbsp;</label><input id="beginDate" name="beginDate" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate"
				value="<fmt:formatDate value="${log.beginDate}" pattern="yyyy-MM-dd hh:mm:ss"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
