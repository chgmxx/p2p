...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#btnSubmit").click(function() { // 借款人列表.
	...
	<form:form id="searchForm" modelAttribute="cgbUserBankCard" action="${ctx}/cgb/cgbUserBankCard/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li>
				...
				<label class="btn">出借人~<input id="lenders_id" type="radio" name="bank_card_type" value="1"/></label>
				<label class="btn">借款人~<input id="borrowers_id" type="radio" name="bank_card_type" value="2" checked="checked"/></label>
			</li>
			<li class="clearfix"></li>
		...
		<tbody>
			<c:forEach items="${page.list}" var="cgbUserBankCard">
				<tr>
					...
					<td>${cgbUserBankCard.creditUserInfo.phone}</td>
					<td>${cgbUserBankCard.creditUserInfo.name}</td>
