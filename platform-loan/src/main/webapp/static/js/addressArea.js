...
dsy.add("0_11_4",["海曙区","江东区","江北区","北仑区","镇海区","鄞州区","高新区","慈溪市","余姚市","奉化市","宁海县","象山县"]);
dsy.add("0_11_5",["越城区","柯桥区","诸暨市","上虞市","嵊州市","绍兴县","新昌县","城关镇"]);
...
dsy.add("0_19_11",["城区片区","松山湖片区","滨海片区","水乡新城片区","东部产业园片区","东南临深片区"]);
dsy.add("0_19_12",["香洲区","斗门区","金湾区"]);
dsy.add("0_19_13",["中山港街道","中区街道","东区街道","西区街道","郊区街道","环城区街道","岐江区街道","莲峰区街道","烟墩区街道","三乡镇","三角镇","大涌镇","小榄镇","五桂山镇","古镇镇","东凤镇","东升镇","民众镇","沙朗镇","沙溪镇","坦洲镇","坦背镇","板芙镇","阜沙镇","南头镇","南朗镇","神湾镇","浪网镇","黄圃镇","港口镇","翠亨村镇","横门镇","横栏镇"]);
...
var s=["l_address_province","l_address_city","l_address_county"];//三个select的name
