...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/cms/notice/form?type=7">教育栏目<shiro:hasPermission name="cms:notice:edit">${not empty notice.id ?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:notice:edit">查看</shiro:lacksPermission></a>
		</li>
	</ul>
	<br/>
	<form:form id="inputForm" modelAttribute="notice" action="${ctx}/cms/notice/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="bannerType" htmlEscape="false" maxlength="1" class="input-xlarge" readonly="true" value="${fns:getDictLabel(notice.bannerType, 'education_type', '')}" />
				<span class="help-inline"></span>
			</div>
		</div>
		<div class="control-group">
