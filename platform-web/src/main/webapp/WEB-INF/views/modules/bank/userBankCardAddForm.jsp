...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules : {
					bankAccountNo : {digits:true,rangelength:[16,19]}
				},
				messages : {
					bankAccountNo : {digits:"请输入正确格式的银行卡号码",rangelength:"请输入正确长度的银行卡号码"}
				},
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/bank/userBankCard/addForm?id=${userBankCard.id}">客户银行卡<shiro:hasPermission name="bank:userBankCard:edit">新增</shiro:hasPermission><shiro:lacksPermission name="bank:userBankCard:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="userBankCard" action="${ctx}/bank/userBankCard/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="bankAccountNo" htmlEscape="false" maxlength="50" class="input-xlarge required" onkeyup="value=value.replace(/[^\d]/g,'') "/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="userId" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="accountId" htmlEscape="false" maxlength="32" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="llAgreeNo" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">银行代码：</label>
			<div class="controls">
				<form:input path="bankNo" htmlEscape="false" maxlength="10" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sn" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="bindDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
					value="<fmt:formatDate value="${userBankCard.bindDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
