...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wloan_subject/wloanSubject/viewForm?id=${wloanSubject.id}">融资主体查看</a></li>
	</ul>
	<br>
			...
			<div class="span6">
				...
				<div class="controls">
					<form:select path="cashierBankCode" class="input-large" id="wloan_subject_select">
						...
						<form:options items="${fns:getDictList('bank_code')}" itemLabel="label" itemValue="value" htmlEscape="false" readonly="true" />
					</form:select>
				</div>
			</div>
		</div>
