...
<body>
	...
	<form:form id="inputForm" modelAttribute="wloanCurrentUserRedeem" action="${ctx}/redeem/wloanCurrentUserRedeem/tocheck" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<!-- 	<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="redeem:wloanCurrentUserRedeem:edit">
