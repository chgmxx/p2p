...
<script type="text/javascript">
	...
	function Init_Wloan_Subject_Choice() {
		...
		if (type_value == '1') {
			...
			var businessLicenseType = $("#businessLicenseType").children('option:selected').val(); // 证照类型，BLC：营业执照，USCC：统一社会信用代码.
			if (businessLicenseType == 'BLC') {
				document.getElementById("taxRegCertNo_OrgCode_id").style.display = "block"; // 组织机构代码与税务登记号.
			} else if (businessLicenseType == 'USCC') {
				// 清空组织机构代码与税务登记号.
					$("#organNo").val(""); // 组织机构代码.
					$("#taxCode").val(""); // 税务登记号.
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/wloan_subject/wloanSubject/cgbProjectWloanSubjectViewForm?id=${wloanSubject.id}">主体查看</a></li>
	</ul>
	<br />
	<form:form id="personalForm" modelAttribute="wloanSubject" action="#" method="post" class="form-horizontal">
		<form:hidden path="id" />
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:select path="type" disabled="true" class="input-large" id="wloan_subject_select">
		...
		<div id="personal_id" style="display: block;">
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:select path="loanApplyId" disabled="true" class="input-xlarge" style="width:264px">
			...
			<div class="control-group">
				<div class="span6">
					<div>
						...
						<div class="controls">
							<form:input path="companyName" readonly="true" htmlEscape="false" maxlength="50" class="input-large required" />
							<span class="help-inline"><font color="red">*</font></span>
						</div>
					</div>
				</div>
		...
		<div id="is_entrusted_pay_id" style="display: none;">
			...
			<div class="control-group">
				<div class="span6">
					<label class="control-label">姓名：</label>
					<div class="controls">
						<form:input path="cashierUser" readonly="true" htmlEscape="false" maxlength="32" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
				<div class="span6">
					<label class="control-label">身份证号：</label>
					<div class="controls">
						<form:input path="cashierIdCard" readonly="true" htmlEscape="false" maxlength="32" class="input-large required" onkeyup="value=value.replace(/[^\d\a-z\A-Z]/g,'')" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span6">
					<label class="control-label">银行卡号：</label>
					<div class="controls">
						<form:input path="cashierBankNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" onkeyup="value=value.replace(/[^\d]/g,'')" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
					<div class="span6">
						<label class="control-label">银行预留手机：</label>
					<div class="controls">
						<form:input path="cashierBankPhone" readonly="true" htmlEscape="false" maxlength="11" class="input-large required" onkeyup="value=value.replace(/[^\d]/g,'')" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span9">
					...
					<div class="controls">
						<form:select path="cicmorganBankCodeId" disabled="true" class="input-xlarge" style="width:333px">
							<form:option value="" label="请选择"/>
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:select path="cashierBankNoFlag" disabled="true" class="input-xlarge required" style="width:264px">
		...
		<div id="cashier_bank_issuer_id" style="display: none;">
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="cashierBankIssuer" readonly="true" htmlEscape="false" maxlength="255" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
		...
		<div id="enterprise_id" style="display: none;">
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<input name="registerDate" disabled="disabled" type="text" readonly="readonly" maxlength="20" class="input-large Wdate " value="<fmt:formatDate value="${wloanSubject.registerDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
					</div>
				</div>
				<div class="span6">
						<label class="control-label">所属行业：</label>
					<div class="controls">
						<form:input path="industry" readonly="true" htmlEscape="false" maxlength="100" class="input-large" />
					</div>
				</div>
			</div>
			<!-- 企业证照. -->
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:select path="businessLicenseType" disabled="true" class="input-xlarge required" style="width:264px">
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="businessNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
				<div class="span6">
					...
					<div class="controls">
						<form:input path="bankPermitCertNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
			<div id="taxRegCertNo_OrgCode_id" style="display: block;">
				<div class="control-group">
					<div class="span6">
						...
						<div class="controls">
							<form:input path="organNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
							<span class="help-inline"><font color="red">*</font></span>
						</div>
					</div>
					<div class="span6">
						...
						<div class="controls">
							<form:input path="taxCode" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
							<span class="help-inline"><font color="red">*</font></span>
						</div>
					</div>
				</div>
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="agentPersonName" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
				<div class="span6">
					...
					<div class="controls">
						<form:input path="agentPersonPhone" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:select path="agentPersonCertType" disabled="true" class="input-xlarge required" style="width:264px">
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="agentPersonCertNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" onkeyup="value=value.replace(/[^\d\a-z\A-Z]/g,'')" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
				...
				<div class="span6">
					...
					<div class="controls">
						<form:select path="corporationCertType" disabled="true" class="input-xlarge required" style="width:264px">
							<form:option value="IDC" label="身份证"/>
							<form:option value="GAT" label="港澳台身份证"/>
							<form:option value="MILIARY" label="军官证"/>
							<form:option value="PASS_PORT" label="护照"/>
			...
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="corporationCertNo" readonly="true" htmlEscape="false" maxlength="64" class="input-large required" onkeyup="value=value.replace(/[^\d\a-z\A-Z]/g,'')" />
						<span class="help-inline"><font color="red">*</font></span>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="lastYearCash" readonly="true" htmlEscape="false" class="input-large " />
				...
				<div class="span6">
					...
					<div class="controls">
						<form:input path="registerAmount" readonly="true" htmlEscape="false" class="input-large " />
						<span class="help-inline"><font color="red">元</font></span>
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span6">
					...
					<div class="controls">
						<form:input path="netAssetAmount" readonly="true" htmlEscape="false" class="input-large " onkeyup="value=value.replace(/[^\d\.]/g,'')" />
						<span class="help-inline"><font color="red">元</font></span>
					</div>
				</div>
				<div class="span6">
					...
					<div class="controls">
						<form:input path="webSite" readonly="true" htmlEscape="false" maxlength="64" class="input-large " />
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span14">
					...
					<div class="controls">
						<form:textarea path="briefName" readonly="true" htmlEscape="false" maxlength="1000" class="input-xxlarge " />
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span14">
					...
					<div class="controls">
						<form:textarea path="briefInfo" readonly="true" htmlEscape="false" maxlength="1000" class="input-xxlarge " />
					</div>
				</div>
			</div>
			<div class="control-group">
				<div class="span14">
					...
					<div class="controls">
						<form:textarea path="runCase" readonly="true" htmlEscape="false" maxlength="500" class="input-xxlarge " />
					</div>
				</div>
			</div>
		</div>
