...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/credit/userinfo/creditUserInfo/form?id=${creditUserInfo.id}">信贷用户<shiro:hasPermission name="credit:userinfo:creditUserInfo:edit">${not empty creditUserInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="credit:userinfo:creditUserInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="creditUserInfo" action="${ctx}/credit/userinfo/creditUserInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="annexFile.id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">手机号：</label>
			<div class="controls">
				<form:input path="phone" htmlEscape="false" maxlength="64" class="input-xlarge required" readonly="true"/>
		...
		<div class="control-group">
			<label class="control-label">手势密码：</label>
			<div class="controls">
				<form:input path="gesturePwd" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div> -->
		<div class="control-group">
