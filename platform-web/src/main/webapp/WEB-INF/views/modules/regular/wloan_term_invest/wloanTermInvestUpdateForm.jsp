...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wloan_term_invest/wloanTermInvest/updateForm?id=${wloanTermInvest.id}">投资记录<shiro:hasPermission name="wloan_term_invest:wloanTermInvest:edit">${not empty wloanTermInvest.id?'修改':'添加'}</shiro:hasPermission> <shiro:lacksPermission name="wloan_term_invest:wloanTermInvest:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="wloanTermInvest" action="${ctx}/wloan_term_invest/wloanTermInvest/updateSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
