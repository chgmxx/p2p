...
public class MenuController extends BaseController {
	...
	public Menu get(@RequestParam(required=false) String id) {
		...
		menu.setCurrentUser(SessionUtils.getUser());
		return menu;
	}
	...
	public String list(Model model) {
		...
		List<Menu> sourcelist = UserUtils.getMenuList(SessionUtils.getUser().getId());
	...
	public String save(Menu menu, Model model, RedirectAttributes redirectAttributes) {
		if(!SessionUtils.getUser().isAdmin()){
...
//		}
	...
	public List<Map<String, Object>> treeData(@RequestParam(required=false) String extId,@RequestParam(required=false) String isShowHide, HttpServletResponse response) {
		...
		List<Menu> list = UserUtils.getMenuList(SessionUtils.getUser().getId());
