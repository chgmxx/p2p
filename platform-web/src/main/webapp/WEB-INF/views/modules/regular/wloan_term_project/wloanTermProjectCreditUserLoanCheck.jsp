	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#cancleCheck").click(function(){
				$("#state").val(0);
				$("#inputForm").attr("action","${ctx}/wloanproject/wloanTermProject/creditUserLoanToBeCheck");
				$("#inputForm").submit();
			});
			// 标的报备.
					...
					success : function(data) {
						...
						for (var i = 0; i < table.length; i++) {
							...
							if(item.id == hiddenReplaceRepayId){
								...
								$("span.select2-chosen:eq(3)").text(item.name + "[" + item.creditScore + "]");
							} else {
					...
					if(typeof(model) == "undefined"){
						...
						for (var i = 0; i < industryObj.options.length; i++) {
							if (industryObj.options[i].value == industry) {
								...
								$("span.select2-chosen:eq(6)").text(industryObj.options[i].text);
								break;
							}
						}
						// 实缴资本.
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/wloanproject/wloanTermProject/creditUserLoanCheck?id=${wloanTermProject.id}">
	...
	<form:form id="inputForm" modelAttribute="wloanTermProject" action="${ctx}/wloanproject/wloanTermProject/creditUserLoanToBeCheck" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:input path="sn" htmlEscape="false" maxlength="32" class="input-xlarge required" style="width:250px" readonly="true"/>
				</div>
			</div>
			<div class="span6">
				<label class="control-label">项目名称：</label>
				<div class="controls">
					<form:input path="name" htmlEscape="false" maxlength="55" class="input-xlarge required" style="width:250px" readonly="true"/>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="span6">
				...
				<div class="controls">
					<a href="${ctx}/credit/annexFile/list?otherId=${creditUserApply.projectDataId}&&remark=${creditUserApply.creditApplyName}">${creditUserApply.creditApplyName}</a>
				</div>
			</div>
			<!-- 
			<div class="span6">
				...
				<div class="controls">
					<a href="${ctx}/credit/annexFile/list?otherId=${wloanTermProject.projectDataId}&&remark=${projectData.name}">${projectData.name}</a>
				</div>
			</div>
			 -->
		</div>
		...
		<div class="control-group">
			...
			<div id="replace_repay_id" style="display: none;">
				<div class="span6">
					...
					<div class="controls">
						<form:select path="replaceRepayId" disabled="true" class="input-xlarge required" style="width:264px">
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<c:if test="${not empty wloanTermProject.span }">
						<c:forEach items="${fns:getDictList('regular_wloan_span')}" var="proSpan">
							<c:if test="${wloanTermProject.span == proSpan.value }">
								<form:input path="span" htmlEscape="false" maxlength="32" class="input-large" readonly="true" value="${proSpan.label }"/>
							</c:if>
						</c:forEach>
					</c:if>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:input path="amount" htmlEscape="false" class="input-large  number required" readonly="true"/>
			...
			<div class="span6">
				...
				<div class="controls">
					<form:input path="marginPercentage" htmlEscape="false" class="input-large  number required" readonly="true" />
					<span class="help-inline">&nbsp;&nbsp;元</span>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:input path="minAmount" htmlEscape="false" class="input-large  number required" readonly="true" />
					<span class="help-inline">&nbsp;&nbsp;元</span>
				</div>
			</div>
			<div class="span6">
				...
				<div class="controls">
					<form:input path="maxAmount" htmlEscape="false" class="input-large  number" readonly="true" />
					<span class="help-inline">&nbsp;&nbsp;元</span>
				</div>
			</div>
		</div>	
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:input path="stepAmount" htmlEscape="false" class="input-large  number required" readonly="true" />
					<span class="help-inline">&nbsp;&nbsp;元</span>
				</div>
			</div>
			<div class="span6">
				...
				<div class="controls">
					<form:input path="feeRate" htmlEscape="false" class="input-large number required" readonly="true" />
					<span class="help-inline">&nbsp;&nbsp;元</span>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<input name="publishDate" type="text" readonly="readonly" maxlength="20" class="input-medium" style="width:250px"
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<input name="loanDate" type="text" readonly="readonly" maxlength="20" class="input-medium" style="width:250px"
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<form:input path="annualRate" htmlEscape="false" class="input-large required" readonly="true"/>
			...
			<div class="span6">
				...
				<div class="controls">
					<form:input path="interestRateIncrease" htmlEscape="false" class="input-large required" readonly="true"/>
					<span class="help-inline">&nbsp;&nbsp;%</span>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<c:if test="${not empty wloanTermProject.repayType }">
						<c:forEach items="${fns:getDictList('wloan_repay_type')}" var="repayType">
							<c:if test="${wloanTermProject.repayType == repayType.value }">
								<input type="text" readonly="readonly" value="${repayType.label}" style="width:250px">
								<form:hidden path="repayType" value="${repayType.value}"/>
							</c:if>
						</c:forEach>
					</c:if>
				</div>
		...
		<div class="control-group">
			<div class="span6">
				...
				<div class="controls">
					<input name="isCanCoupon" type="text" readonly="readonly" maxlength="20" class="input-medium" style="width:250px"
						value="${wloanTermProject.isCanUseCoupon == '0' ? '是' : '否'}"/>
				</div>
			</div>
			<div class="span6">
				<label class="control-label">是否可用加息券：</label>
				<div class="controls">
					<input name="isCanPlusCoupon" type="text" readonly="readonly" maxlength="20" class="input-medium" style="width:250px"
						value="${wloanTermProject.isCanUsePlusCoupon == '0' ? '是' : '否'}"/>
				</div>
			</div>
		</div>
		...
		<div id="replace_repay_residence_id" style="display: none;">
			<div class="control-group">
				<div class="span10">
					...
					<div class="controls">
						<form:textarea path="replaceRepayResidence" htmlEscape="false" class="input-xxlarge required" rows="2" readonly="true" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="guaranteeScheme" htmlEscape="false"  class="input-xxlarge" rows="4" readonly="true" />
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="projectCase" htmlEscape="false"  class="input-xxlarge" rows="4" readonly="true" />
				</div>
			</div>
		</div>	
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="purpose" htmlEscape="false" class="input-xxlarge" rows="4"  readonly="true" />
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="sourceOfRepayment" htmlEscape="false" class="input-xxlarge" rows="4" readonly="true" />
				</div>
			</div>
		</div>
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="remark" htmlEscape="false" maxlength="500" class="input-xxlarge" rows="4" readonly="true" />
				</div>
			</div>
		</div>
