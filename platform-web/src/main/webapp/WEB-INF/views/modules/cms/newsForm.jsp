...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/cms/notice/form?id=${notice.id }&type=3">新闻<shiro:hasPermission name="cms:notice:edit">${not empty notice.id ?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:notice:edit">查看</shiro:lacksPermission></a>
		</li>
	</ul>
	<br/>
