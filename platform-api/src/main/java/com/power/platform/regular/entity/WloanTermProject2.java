 ...
 */
public class WloanTermProject2 extends DataEntity<WloanTermProject> {
	...
	private String subjectType; // 融资类型（导出）
	...
	public WloanTermProject2() {

		super();
	}

	public WloanTermProject2(String id) {
	...
	@ExcelField(title = "融资金额(元)", align = 2, sort = 6)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
	@ExcelField(title = "流标日期", align = 2, sort = 7)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
	@ExcelField(title = "放款日期", align = 2, sort = 8)
	...
	@ExcelField(title = "融资类型", align = 2, sort = 3)
	...
	@ExcelField(title = "项目状态", align = 2, sort = 9)
	...
	@ExcelField(title = "融资方", align = 2, sort = 4)
	...
	@ExcelField(title = "需求编号", align = 2, sort = 1)
	...
	@ExcelField(title = "还款方", align = 2, sort = 5)
