...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/notice/?type=1">电脑端-BANNER</a></li>
	...
	<form:form id="searchForm" modelAttribute="notice" action="${ctx}/cms/notice/?type=1" method="post" class="breadcrumb form-search">
