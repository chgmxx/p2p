...
import com.power.platform.common.utils.Collections3;
...
import com.power.platform.sys.service.OfficeService;
...
public class RoleController extends BaseController {
	...
	public Role get(@RequestParam(required=false) String id) {
		...
		role.setCurrentUser(SessionUtils.getUser());
		return role;
	}
	...
	public String form(Role role, Model model) {
		if (role.getOffice()==null){
			role.setOffice(SessionUtils.getUser().getOffice());
		}
		model.addAttribute("role", role);
		model.addAttribute("menuList", UserUtils.getMenuList(SessionUtils.getUser().getId()));
	...
	public String save(Role role, Model model, RedirectAttributes redirectAttributes) {
		if(!SessionUtils.getUser().isAdmin()&&role.getSysData().equals(Global.YES)){
...
//		}
	...
	public String assign(Role role, Model model) {
		try {
			...
			User user =new User();
			user.setRole(role);
			user.setCurrentUser(role.getCurrentUser());
	...
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) {
		...
		if (SessionUtils.getUser().getId().equals(userId)) {
