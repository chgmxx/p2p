			...
			<div id="content" class="row-fluid">
				<div id="left">
					...
					<div class="panel-group" id="accordion">
						<div class="panel panel-default" id="companyInfo">
						...
						<div class="panel panel-default" >
							<div class="panel-heading menu_tab">
								<div class="panel-title">借款管理<span class="caret pull-right"></span></div>
							</div>
							<div class="panel-collapse menu_con01">
							    <ul class="list-group">
							    	...
							    	<li class="list-group-item menu_tab02">
							    	   <div>借款申请列表<span class="caret pull-right"></span></div>
							    	  <div class="menu_con02">
							    	  	<ul class="list-group">
							    	  		<li class="list-group-item">
							    	  			<span>借款申请</span>
							    	  		</li>
