...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/approval/proinfo/form">放款信息总经理审批</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="projectApproval" action="${ctx}/approval/proinfo/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="financeOption" htmlEscape="false" class="input-xxlarge" rows="4" value="${projectApproval.financeOption }" readonly="true"/>
				</div>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<div class="span10">
				...
				<div class="controls">
					<form:textarea path="rcerManagerOption" htmlEscape="false" class="input-xxlarge" rows="4"/>
				</div>
			</div>
		</div>
		<!-- 风控经理信息end -->
