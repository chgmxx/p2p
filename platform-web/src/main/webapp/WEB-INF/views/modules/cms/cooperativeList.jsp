...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/notice/?type=5">机构列表</a></li>
		<shiro:hasPermission name="cms:notice:edit">
			<li><a href="${ctx}/cms/notice/form?type=5">机构添加</a>
			</li>
		</shiro:hasPermission> 
	</ul>
	<form:form id="searchForm" modelAttribute="notice" action="${ctx}/cms/notice/?type=5" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>机构名称</th><th>显示顺序</th><th>创建时间</th><th>是否在线</th><shiro:hasPermission name="cms:notice:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
