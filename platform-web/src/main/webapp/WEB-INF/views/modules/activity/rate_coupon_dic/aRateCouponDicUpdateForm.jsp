...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/activity/aRateCouponDic/updateForm?id=${aRateCouponDic.id}">加息券字典数据<shiro:hasPermission name="activity:aRateCouponDic:edit">${not empty aRateCouponDic.id?'修改':'添加'}</shiro:hasPermission> <shiro:lacksPermission name="activity:aRateCouponDic:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="aRateCouponDic" action="${ctx}/activity/aRateCouponDic/updateSave" method="post" class="form-horizontal">
		<form:hidden path="id" />
