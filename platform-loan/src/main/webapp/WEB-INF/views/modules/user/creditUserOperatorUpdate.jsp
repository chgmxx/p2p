...
<body>
 <div class="nav_head">操作人修改</div>
	<form:form id="inputForm" modelAttribute="creditUserOperator" action="${ctx}/credit/cuoperator/creditUserOperator/toUpdate" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存" onclick="toSave()"/>&nbsp;
