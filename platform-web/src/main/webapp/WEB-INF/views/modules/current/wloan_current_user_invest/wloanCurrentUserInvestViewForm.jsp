...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/wloan_current_user_invest/wloanCurrentUserInvest/viewForm?id=${wloanCurrentUserInvest.id}">活期客户投资查看</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="wloanCurrentUserInvest" action="#" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<div class="span7">
				...
				<div class="controls">
					<input name="bidDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate " value="<fmt:formatDate value="${wloanCurrentUserInvest.bidDate}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
				</div>
			</div>
			<div class="span7">
